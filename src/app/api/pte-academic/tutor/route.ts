...
const EXAM_ID = "pte-academic";
const EXAM_DISPLAY_NAME = "PTE Academic";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Speaking & Writing, Reading, and Listening. Explain AI scoring criteria and test-taking strategies for each task type. Align to Pearson PTE Academic format.
