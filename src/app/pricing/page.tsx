...
export const metadata: Metadata = {
  title: "Pricing — Pte Academic Premium",
  description: "Unlock unlimited Pte Academic practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=pte-academic&cadence=annual`;
