// Auto-generated shim — re-exports from @/lib/pte-academic/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _pte_academic_Config } from "@/lib/pte-academic/config";
import { EXAM_CONFIG as _raw } from "@/lib/pte-academic/config";
